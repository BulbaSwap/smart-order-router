...
const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.HOODI]: [WRAPPED_NATIVE_CURRENCY[ChainId.HOODI]!, USDT_HOODI, USDC_HOODI],
  [ChainId.MORPH]: [WRAPPED_NATIVE_CURRENCY[ChainId.MORPH]!, USDT_MORPH, USDC_MORPH, BGB_MORPH],
