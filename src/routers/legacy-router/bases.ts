...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.HOLESKY]: [WRAPPED_NATIVE_CURRENCY[ChainId.HOLESKY]!],
    [ChainId.HOODI]: [WRAPPED_NATIVE_CURRENCY[ChainId.HOODI]!],
    [ChainId.MORPH]: [WRAPPED_NATIVE_CURRENCY[ChainId.MORPH]!],
